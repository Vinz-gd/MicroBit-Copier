...
public class Gui extends JFrame {
  ...
  public Gui() { 
    ...
    bHilfe.setForeground(Color.BLACK);
    ...
    bFertig.setForeground(Color.BLACK);
    cp.add(bFertig);
    ...
    bMicroBitauswaehlen.setForeground(Color.BLACK);
    ...
    bProgrammauswaehlen1.setForeground(Color.BLACK);
